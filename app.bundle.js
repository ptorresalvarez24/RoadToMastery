...
`;
  ...
  function WeekDetail({ navigate, weekNum = 3 }) {
    ...
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14, marginBottom: 28 } }, media.length === 0 && [...Array(6)].map((_, i) => /* @__PURE__ */ React.createElement(Placeholder, { key: i, label: i < 2 ? "Screenshot" : "Drop here", width: "100%", height: 170, color: "#e0d8cc", style: { width: "100%", borderRadius: 6, border: "1px dashed var(--border-mid)" } })), media.map((m) => /* @__PURE__ */ React.createElement(Card, { key: m.id, style: { padding: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, m.type?.startsWith("video/") ? /* @__PURE__ */ React.createElement("video", { src: m.url, controls: true, style: { width: "100%", height: 170, objectFit: "cover", borderRadius: 4, background: "#000" } }) : /* @__PURE__ */ React.createElement("img", { src: m.url, alt: m.name, style: { width: "100%", height: 170, objectFit: "cover", borderRadius: 4 } }), /* @__PURE__ */ React.createElement(
      "button",
      {
